...
func DynamicCasbinRuleTable(c *CasbinRule) func(db *gorm.DB) *gorm.DB {
	return func(db *gorm.DB) *gorm.DB {
		return db.Table(c.TablePrefix + c.TableName) //as Gorm keeps table names are plural, and we love consistency
	}
}
...
func (a *Adapter) open() error {
	...
	a.db = db.Scopes(CasbinTableName(&CasbinRule{TableName:a.tableName,TablePrefix:a.tablePrefix})).Debug()
